...
Donate link: https://kolakube.com/comments-leaderboard/
Tags: top commentators, top commenters, top comments, comments list
...
1. Upload `comments-leaderboard` to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Go to Appearance > Widgets and find the 'Comments Leaderboard' Widget. Drag it into your blog's sidebar (or other Widget area), fill in a title and color, and you're all done!
...
1. By default, the Comments Leaderboard shows a red color spectrum.

2. This is what the Widget settings look like with some text filled in.

3. An alternative color scheme (tip: you can set any hex color code in the Widget settings)
